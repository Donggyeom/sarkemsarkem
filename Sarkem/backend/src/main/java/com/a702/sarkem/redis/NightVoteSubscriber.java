...
import com.a702.sarkem.model.game.message.NightVoteMessage;
...
//	private final GamePublisher redisPublisher;
...
//			String deadPlayerId = roleVote.get(GameRole.SARK); // 삵이 투표해서 죽은 플래이어 아이디
//			String protectedPlayerId = roleVote.get(GameRole.DOCTOR); // 의사가 투표해서 지켜진 플래이어 아이디
//			String suspectPlayerId = roleVote.get(GameRole.POLICE); // 경찰이 투표해서 조사받을 플래이어 아이디
//			String slientPlayerId = roleVote.get(GameRole.ACHI); // 냥아치가 투표해서 조용해야 할 플래이어 아이디
//
